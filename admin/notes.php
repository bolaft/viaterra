 ...
 * @version $Id: notes_extras_dhtml.php v0.95 2008-12-16 Paul Mathot $
 */
...
switch($_GET['action']){
  ...
  case 'insert_new':
    ...
    $db->Execute("INSERT INTO " . TABLE_NOTES . "
                        (`notes_title`, `notes_date_created`, `notes_start_date`, `notes_end_date`, `notes_categories_id`, `notes_status`)
                        VALUES('New note',NOW(), NOW(), '0001-01-01','1','1')");
    $insert_id = mysql_insert_id();
...
<?php
  ...
  case 'categories':
    echo '<p>';
    echo '<a href="' . zen_href_link(FILENAME_NOTES, '', 'NONSSL') . '">' . 'Back to notes' . '</a>';
    echo '&nbsp;|&nbsp;';
              ...
              <tr>
                <td colspan="6"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <td class="smallText" align="right"><?php echo $notes_split->display_links($notes_query_numrows, MAX_DISPLAY_SEARCH_RESULTS, MAX_DISPLAY_PAGE_LINKS, $_GET['page']); ?></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
