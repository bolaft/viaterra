...
?></legend>
	...
	<fieldset class="AdvancedShipperRegion<?php echo ((($method_num) % 2 == 0) ? 'Even' : 'Odd'); ?>ConfigPanel">
		...
		<table cellpadding="0" cellspacing="0" width="100%" border="0">
			...
			<tr>
				<td class="AdvancedShipperConfigField">
					<?php echo advshipper_draw_radio_field('rate_limits_inc', ADVSHIPPER_RATE_LIMITS_INC_INC, $rate_limits_inc == ADVSHIPPER_RATE_LIMITS_INC_INC, null, 'id="rate_limits_inc_inc" onKeyPress="advshipperCheckEnterPressed(event)"'); ?> <?php echo TEXT_RATE_LIMITS_INC; ?>
					<br /><?php echo advshipper_draw_radio_field('rate_limits_inc', ADVSHIPPER_RATE_LIMITS_INC_EXC, $rate_limits_inc == ADVSHIPPER_RATE_LIMITS_INC_EXC, null, 'id="rate_limits_inc_exc" onKeyPress="advshipperCheckEnterPressed(event)"'); ?> <?php echo TEXT_RATE_LIMITS_EXC; ?>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="AdvancedShipperConfigField">
					<?php echo zen_draw_input_field('surcharge', $surcharge, 'size="40" maxlength="40" id="surcharge" onKeyPress="advshipperCheckEnterPressed(event)"'); ?>
				</td>
			</tr>
			<tr>
