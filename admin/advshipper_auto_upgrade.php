 ...
 * @version    $Id: advshipper_auto_upgrade.php 313 2009-02-23 11:26:11Z Bob $
 */
...
if (substr(MODULE_ADVANCED_SHIPPER_MADE_BY_CEON, 0, 3) == '3.0') {
	if (MODULE_ADVANCED_SHIPPER_MADE_BY_CEON == '3.0.0' ||
		MODULE_ADVANCED_SHIPPER_MADE_BY_CEON == '3.0.1'||
		MODULE_ADVANCED_SHIPPER_MADE_BY_CEON == '3.0.2') {
