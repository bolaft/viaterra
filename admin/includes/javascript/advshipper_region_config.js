 ...
 * @version    $Id: advshipper_region_config.js 313 2009-02-23 11:26:11Z Bob $
 */
...
function advshipperSaveRegion(region_num, update_region)
{
	...
	if (!update_region) {
		window.opener.advshipperInsertRegion(region_num, _admin_titles_string, _titles_string, _definition_method, _countries_postcodes, _countries_zones_string, _countries_states_string, _countries_cities_string, _distance, _tax_class, _rates_include_tax, _rate_limits_inc, _table_of_rates, _max_weight_per_package, _packaging_weights, _surcharge, _surcharge_titles_string, _ups_calc_string, _usps_calc_string);
	} else {
		window.opener.advshipperUpdateRegion(region_num, _admin_titles_string, _titles_string, _definition_method, _countries_postcodes, _countries_zones_string, _countries_states_string, _countries_cities_string, _distance, _tax_class, _rates_include_tax, _rate_limits_inc, _table_of_rates, _max_weight_per_package, _packaging_weights, _surcharge, _surcharge_titles_string, _ups_calc_string, _usps_calc_string);
	}
...
function advshipperCheckRegionConfiguration(definition_method, countries_postcodes, countries_zones_string, countries_states_string, countries_cities_string, distance, table_of_rates, surcharge)
{
	...
	if (table_of_rates == null || table_of_rates.length == 0) {
		...
		if (!table_of_rates.match(/^\s*\<(<?php echo ADVSHIPPER_CALC_METHOD_WEIGHT; ?>|<?php echo ADVSHIPPER_CALC_METHOD_PRICE; ?>|<?php echo ADVSHIPPER_CALC_METHOD_NUM_ITEMS; ?>|<?php echo ADVSHIPPER_CALC_METHOD_SHIPPING_RATE; ?>)\>.*\<\/\1\>\s*$/)) {			errors += '<?php echo ADVSHIPPER_JS_ERROR_TABLE_OF_RATES_FORMAT; ?>';
		}
	...
	if (surcharge != null && surcharge.length != 0 &&
			...
			(!surcharge.match(/^\s*\<(<?php echo ADVSHIPPER_CALC_METHOD_WEIGHT; ?>|<?php echo ADVSHIPPER_CALC_METHOD_PRICE; ?>|<?php echo ADVSHIPPER_CALC_METHOD_NUM_ITEMS; ?>|<?php echo ADVSHIPPER_CALC_METHOD_SHIPPING_RATE; ?>)\>.+\<\/\1\>\s*$/) ||
