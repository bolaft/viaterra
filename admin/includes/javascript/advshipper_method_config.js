 ...
 * @version    $Id: advshipper_method_config.js 313 2009-02-23 11:26:11Z Bob $
 */
...
function advshipperInsertRegion(region_num, admin_titles_string, titles_string, definition_method, countries_postcodes, countries_zones_string, countries_states_string, countries_cities_string, distance, tax_class, rates_include_tax, rate_limits_inc, table_of_rates, max_weight_per_package, packaging_weights, surcharge, surcharge_titles_string, ups_calc_string, usps_calc_string)
{
...
function advshipperBuildRegionsPanel()
{
	...
	if (num_regions == 0) {
		...
		for (region_i = 0; region_i < num_regions; region_i++) {
			...
			_regions_info_el.value += escape(_admin_titles_encoded) + '[[]]';
			...
			_regions_info_el.value += escape(_titles_encoded) + '[[]]';
			...
			_regions_info_el.value += escape(_surcharge_titles_encoded) + '[[]]';
