...
// email disclaimer
  define('EMAIL_DISCLAIMER', 'Nous avons eu cette adresse E-mail par un de nos clients. Si vous recevez cet e-mail par erreur, merci de contacter: %s');
  ...
  define('TEXT_UNSUBSCRIBE', "\n\nPour ne plus recevoir la newsletter, veuillez cliquer sur ce lien: \n");
