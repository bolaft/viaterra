...
// email disclaimer
  ...
  define('EMAIL_FOOTER_COPYRIGHT','Copyright (c) ' . date('Y') . ' <a href="http:/viaterra.net" target="_blank">Viaterra.net</a>. Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a>');
  ...
  define('TEXT_UNSUBSCRIBE', "\n\nTo unsubscribe, simply click on the following link: <br>");
