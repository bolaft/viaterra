 ...
 * @version    $Id: advshipper_region_config.php 313 2009-02-23 11:26:11Z Bob $
 */
...
define('TEXT_RATE_LIMITS_INC', 'Rate Limits Are Inclusive');
define('TEXT_RATE_LIMITS_EXC', 'Rate Limits Are Exclusive');
...
define('TEXT_CONFIG_DESC_PACKAGING_WEIGHTS', 'For rates being calculated using the <strong>weight</strong> of the applicable products, a table of the packaging weights to be added on to the weight of the applicable products - before the rate for the <strong>weight</strong> is calculated - can be entered here. E.g. &ldquo;0-5:0.03, *:0.2+1%&rdquo;.');
define('TEXT_LABEL_SURCHARGE', 'Surcharge:');
define('TEXT_CONFIG_DESC_SURCHARGE', 'This is the surcharge for orders shipped to this region (if any). It can be a flat rate, e.g. 1.50. Or it could be a percentage (plus optional flat rate), or combination rate, of the <strong>weight</strong>, <strong>price</strong> or the <strong>numitems</strong> of the applicable products. It can even be a percentage (plus optional flat rate), or combination rate, of the <strong>shipping</strong> rate calculated for this method. E.g. &lt;shipping&gt;1%+0.50&lt;/shipping&gt; or &lt;weight&gt;8%&lt;/weight&gt;.');
