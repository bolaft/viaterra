...
// +----------------------------------------------------------------------+
//  $Id: tax_rates.php,v 1.2 2006/01/11 21:11:49 gorkau Exp $
//

define('HEADING_TITLE', 'Tasas de Impuesto');
...
define('TEXT_INFO_HEADING_NEW_TAX_RATE', 'Nuevo impuesto');
define('TEXT_INFO_HEADING_EDIT_TAX_RATE', 'Editar Impuesto');
define('TEXT_INFO_HEADING_DELETE_TAX_RATE', 'Eliminar Impuesto');
?>
