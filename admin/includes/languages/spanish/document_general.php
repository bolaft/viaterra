...
// +----------------------------------------------------------------------+
//  $Id: document_general.php,v 1.2 2006/01/14 13:32:20 damage_in Exp $
//
...
define('TEXT_RESTRICT_PRODUCT_TYPE', 'Restringir a tipo de producto');
...
define('ERROR_CATALOG_IMAGE_DIRECTORY_NOT_WRITEABLE', 'Error: No se puede escribir en el directorio de las imágenes del catálogo: ' . DIR_FS_CATALOG_IMAGES);
...
define('ERROR_CANNOT_MOVE_CATEGORY_TO_PARENT', 'Error: No se puede mover una categoría a una subcategoría.');
define('ERROR_CANNOT_MOVE_PRODUCT_TO_CATEGORY_SELF', 'Error: No se puede mover el producto a la misma categoría o a una categoría donde ya existe.');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_INFO_ATTRIBUTES_FEATURES_COPY_TO_CATEGORY', 'Copiar aAttributos a otra <strong>categoría</strong> desde:<br />');
  ...
  define('TEXT_VIRTUAL_PREVIEW', 'Advertencia: Este producto fue marcado para envío gratuito y sin dirección de envío');
  define('TEXT_VIRTUAL_EDIT', 'Advertencia: Este producto fue marcado para envío gratuito y sin dirección de envío');
  define('TEXT_FREE_SHIPPING_PREVIEW', 'Advertencia: Este producto fue marcado para envío gratuito, con dirección de envío');
